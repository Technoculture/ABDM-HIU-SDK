...
class TestEntryContentModel(unittest.TestCase):
    """EntryContentModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntryContentModel:
        """Test EntryContentModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntryContentModel`
        """
        model = EntryContentModel()
        if include_optional:
            return EntryContentModel(
                content = 'Encrypted content of data packaged in FHIR bundle',
                media = 'application/fhir+json',
                checksum = '',
                care_context_reference = 'RVH1008'
            )
        else:
            return EntryContentModel(
                content = 'Encrypted content of data packaged in FHIR bundle',
    ...
    def testEntryContentModel(self):
        """Test EntryContentModel"""
