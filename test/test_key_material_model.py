...
class TestKeyMaterialModel(unittest.TestCase):
    """KeyMaterialModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KeyMaterialModel:
        """Test KeyMaterialModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KeyMaterialModel`
        """
        model = KeyMaterialModel()
        if include_optional:
            return KeyMaterialModel(
                crypto_alg = 'ECDH',
                curve = 'Curve25519',
