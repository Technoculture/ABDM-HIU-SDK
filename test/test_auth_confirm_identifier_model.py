...
class TestAuthConfirmIdentifierModel(unittest.TestCase):
    """AuthConfirmIdentifierModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthConfirmIdentifierModel:
        """Test AuthConfirmIdentifierModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthConfirmIdentifierModel`
        """
        model = AuthConfirmIdentifierModel()
        if include_optional:
            return AuthConfirmIdentifierModel(
                type = 'MOBILE',
                value = '+919800083232'
            )
        else:
    ...
    def testAuthConfirmIdentifierModel(self):
        """Test AuthConfirmIdentifierModel"""
