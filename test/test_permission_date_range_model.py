...
class TestPermissionDateRangeModel(unittest.TestCase):
    """PermissionDateRangeModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PermissionDateRangeModel:
        """Test PermissionDateRangeModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PermissionDateRangeModel`
        """
        model = PermissionDateRangeModel()
        if include_optional:
            return PermissionDateRangeModel(
    ...
    def testPermissionDateRangeModel(self):
        """Test PermissionDateRangeModel"""
