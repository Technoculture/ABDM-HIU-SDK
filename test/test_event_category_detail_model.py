...
class TestEventCategoryDetailModel(unittest.TestCase):
    """EventCategoryDetailModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventCategoryDetailModel:
        """Test EventCategoryDetailModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventCategoryDetailModel`
        """
        model = EventCategoryDetailModel()
        if include_optional:
            return EventCategoryDetailModel(
    ...
    def testEventCategoryDetailModel(self):
        """Test EventCategoryDetailModel"""
