...
class TestDataNotificationModel(unittest.TestCase):
    """DataNotificationModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataNotificationModel:
        """Test DataNotificationModel
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DataNotificationModel`
        """
        model = DataNotificationModel()
        if include_optional:
    ...
    def testDataNotificationModel(self):
        """Test DataNotificationModel"""
