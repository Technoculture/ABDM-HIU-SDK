...
class TestPatientAuthInitResponseModel(unittest.TestCase):
    """PatientAuthInitResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatientAuthInitResponseModel:
        """Test PatientAuthInitResponseModel
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PatientAuthInitResponseModel`
        """
        model = PatientAuthInitResponseModel()
        if include_optional:
            return PatientAuthInitResponseModel(
    ...
    def testPatientAuthInitResponseModel(self):
        """Test PatientAuthInitResponseModel"""
