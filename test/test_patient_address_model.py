...
class TestPatientAddressModel(unittest.TestCase):
    """PatientAddressModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatientAddressModel:
        """Test PatientAddressModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatientAddressModel`
        """
        model = PatientAddressModel()
        if include_optional:
    ...
    def testPatientAddressModel(self):
        """Test PatientAddressModel"""
