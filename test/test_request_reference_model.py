...
class TestRequestReferenceModel(unittest.TestCase):
    """RequestReferenceModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequestReferenceModel:
        """Test RequestReferenceModel
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RequestReferenceModel`
        """
        model = RequestReferenceModel()
        if include_optional:
            return RequestReferenceModel(
                request_id = ''
            )
        else:
            return RequestReferenceModel(
    ...
    def testRequestReferenceModel(self):
        """Test RequestReferenceModel"""
