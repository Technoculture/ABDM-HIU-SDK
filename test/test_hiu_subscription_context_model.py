...
class TestHIUSubscriptionContextModel(unittest.TestCase):
    """HIUSubscriptionContextModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HIUSubscriptionContextModel:
        """Test HIUSubscriptionContextModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HIUSubscriptionContextModel`
        """
        model = HIUSubscriptionContextModel()
        if include_optional:
            return HIUSubscriptionContextModel(
    ...
    def testHIUSubscriptionContextModel(self):
        """Test HIUSubscriptionContextModel"""
