...
class TestSubscriptionRequestSubscriptionModel(unittest.TestCase):
    """SubscriptionRequestSubscriptionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionRequestSubscriptionModel:
        """Test SubscriptionRequestSubscriptionModel
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SubscriptionRequestSubscriptionModel`
        """
        model = SubscriptionRequestSubscriptionModel()
        if include_optional:
            return SubscriptionRequestSubscriptionModel(
                ...
                hiu = abdm.models.organization_representation.OrganizationRepresentation(
                    id = '', ),
                hips = [
                    abdm.models.organization_representation.OrganizationRepresentation(
                        id = '', )
                    ],
                categories = [
                    'LINK'
    ...
    def testSubscriptionRequestSubscriptionModel(self):
        """Test SubscriptionRequestSubscriptionModel"""
