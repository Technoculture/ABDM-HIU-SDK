...
class TestHealthInformationNotificationNotificationStatusNotificationModel(unittest.TestCase):
    """HealthInformationNotificationNotificationStatusNotificationModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HealthInformationNotificationNotificationStatusNotificationModel:
        """Test HealthInformationNotificationNotificationStatusNotificationModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HealthInformationNotificationNotificationStatusNotificationModel`
        """
        model = HealthInformationNotificationNotificationStatusNotificationModel()
        if include_optional:
            return HealthInformationNotificationNotificationStatusNotificationModel(
    ...
    def testHealthInformationNotificationNotificationStatusNotificationModel(self):
        """Test HealthInformationNotificationNotificationStatusNotificationModel"""
