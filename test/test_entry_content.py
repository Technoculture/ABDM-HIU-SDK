...
class TestEntryContent(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EntryContent:
        """Test EntryContent
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntryContent`
        """
        model = EntryContent()
        if include_optional:
            return EntryContent(
