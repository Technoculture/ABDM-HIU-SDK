...
class TestHeartbeatResponseModel(unittest.TestCase):
    """HeartbeatResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HeartbeatResponseModel:
        """Test HeartbeatResponseModel
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HeartbeatResponseModel`
        """
        model = HeartbeatResponseModel()
        if include_optional:
    ...
    def testHeartbeatResponseModel(self):
        """Test HeartbeatResponseModel"""
