...
class TestRequesterIdentifierModel(unittest.TestCase):
    """RequesterIdentifierModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequesterIdentifierModel:
        """Test RequesterIdentifierModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequesterIdentifierModel`
        """
        model = RequesterIdentifierModel()
        if include_optional:
            return RequesterIdentifierModel(
                type = 'REGNO',
                value = 'MH1001',
    ...
    def testRequesterIdentifierModel(self):
        """Test RequesterIdentifierModel"""
