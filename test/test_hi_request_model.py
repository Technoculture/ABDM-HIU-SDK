...
class TestHIRequestModel(unittest.TestCase):
    """HIRequestModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HIRequestModel:
        """Test HIRequestModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HIRequestModel`
        """
        model = HIRequestModel()
        if include_optional:
            return HIRequestModel(
                request_id = '',
                timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                hi_request = abdm.models.hi_request_hi_request.HIRequest_hiRequest(
