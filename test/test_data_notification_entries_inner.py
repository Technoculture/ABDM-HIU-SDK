...
class TestDataNotificationEntriesInner(unittest.TestCase):
    """DataNotificationEntriesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataNotificationEntriesInner:
        """Test DataNotificationEntriesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataNotificationEntriesInner`
        """
        model = DataNotificationEntriesInner()
        if include_optional:
            return DataNotificationEntriesInner(
    ...
    def testDataNotificationEntriesInner(self):
        """Test DataNotificationEntriesInner"""
