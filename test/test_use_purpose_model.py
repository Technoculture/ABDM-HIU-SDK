...
class TestUsePurposeModel(unittest.TestCase):
    """UsePurposeModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsePurposeModel:
        """Test UsePurposeModel
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UsePurposeModel`
        """
        model = UsePurposeModel()
        if include_optional:
            return UsePurposeModel(
                text = '',
                code = '',
                ref_uri = ''
            )
