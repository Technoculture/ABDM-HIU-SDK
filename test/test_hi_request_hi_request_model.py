...
class TestHIRequestHiRequestModel(unittest.TestCase):
    """HIRequestHiRequestModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HIRequestHiRequestModel:
        """Test HIRequestHiRequestModel
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HIRequestHiRequestModel`
        """
        model = HIRequestHiRequestModel()
        if include_optional:
            return HIRequestHiRequestModel(
                consent = abdm.models.consent.consent(
                    id = '', ),
                date_range = abdm.models.date_range.DateRange(
                ...
                data_push_url = '',
                key_material = abdm.models.key_material.KeyMaterial(
                    crypto_alg = 'ECDH', 
                    curve = 'Curve25519', 
    ...
    def testHIRequestHiRequestModel(self):
        """Test HIRequestHiRequestModel"""
