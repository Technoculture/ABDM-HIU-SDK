...
class TestCareContextDefinitionModel(unittest.TestCase):
    """CareContextDefinitionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CareContextDefinitionModel:
        """Test CareContextDefinitionModel
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CareContextDefinitionModel`
        """
        model = CareContextDefinitionModel()
        if include_optional:
            return CareContextDefinitionModel(
    ...
    def testCareContextDefinitionModel(self):
        """Test CareContextDefinitionModel"""
