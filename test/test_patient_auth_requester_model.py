...
class TestPatientAuthRequesterModel(unittest.TestCase):
    """PatientAuthRequesterModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatientAuthRequesterModel:
        """Test PatientAuthRequesterModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatientAuthRequesterModel`
        """
        model = PatientAuthRequesterModel()
        if include_optional:
            return PatientAuthRequesterModel(
                type = 'HIP',
                id = '100005'
            )
        else:
    ...
    def testPatientAuthRequesterModel(self):
        """Test PatientAuthRequesterModel"""
