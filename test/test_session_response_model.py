...
class TestSessionResponseModel(unittest.TestCase):
    """SessionResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SessionResponseModel:
        """Test SessionResponseModel
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SessionResponseModel`
        """
        model = SessionResponseModel()
        if include_optional:
    ...
    def testSessionResponseModel(self):
        """Test SessionResponseModel"""
