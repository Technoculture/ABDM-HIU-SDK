...
class TestSubscriptionApprovalNotificationNotificationModel(unittest.TestCase):
    """SubscriptionApprovalNotificationNotificationModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionApprovalNotificationNotificationModel:
        """Test SubscriptionApprovalNotificationNotificationModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionApprovalNotificationNotificationModel`
        """
        model = SubscriptionApprovalNotificationNotificationModel()
        if include_optional:
            return SubscriptionApprovalNotificationNotificationModel(
    ...
    def testSubscriptionApprovalNotificationNotificationModel(self):
        """Test SubscriptionApprovalNotificationNotificationModel"""
