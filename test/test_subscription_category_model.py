...
class TestSubscriptionCategoryModel(unittest.TestCase):
    """SubscriptionCategoryModel unit test stubs"""
    ...
    def testSubscriptionCategoryModel(self):
        """Test SubscriptionCategoryModel"""
        # inst = SubscriptionCategoryModel()
