...
class TestKeyObjectModel(unittest.TestCase):
    """KeyObjectModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KeyObjectModel:
        """Test KeyObjectModel
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `KeyObjectModel`
        """
        model = KeyObjectModel()
        if include_optional:
            return KeyObjectModel(
