...
class TestPermissionFrequencyModel(unittest.TestCase):
    """PermissionFrequencyModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PermissionFrequencyModel:
        """Test PermissionFrequencyModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PermissionFrequencyModel`
        """
        model = PermissionFrequencyModel()
        if include_optional:
            return PermissionFrequencyModel(
                unit = 'HOUR',
                value = 56,
                repeats = 56
            )
    ...
    def testPermissionFrequencyModel(self):
        """Test PermissionFrequencyModel"""
