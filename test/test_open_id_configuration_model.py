...
class TestOpenIdConfigurationModel(unittest.TestCase):
    """OpenIdConfigurationModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpenIdConfigurationModel:
        """Test OpenIdConfigurationModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenIdConfigurationModel`
        """
        model = OpenIdConfigurationModel()
        if include_optional:
    ...
    def testOpenIdConfigurationModel(self):
        """Test OpenIdConfigurationModel"""
