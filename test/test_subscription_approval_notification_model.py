...
class TestSubscriptionApprovalNotificationModel(unittest.TestCase):
    """SubscriptionApprovalNotificationModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionApprovalNotificationModel:
        """Test SubscriptionApprovalNotificationModel
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SubscriptionApprovalNotificationModel`
        """
        model = SubscriptionApprovalNotificationModel()
        if include_optional:
            return SubscriptionApprovalNotificationModel(
                request_id = '5f7a535d-a3fd-416b-b069-c97d021fbacd',
                timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                notification = abdm.models.subscription_approval_notification_notification.SubscriptionApprovalNotification_notification(
    ...
    def testSubscriptionApprovalNotificationModel(self):
        """Test SubscriptionApprovalNotificationModel"""
