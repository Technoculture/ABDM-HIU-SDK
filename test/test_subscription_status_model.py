...
class TestSubscriptionStatusModel(unittest.TestCase):
    """SubscriptionStatusModel unit test stubs"""
    ...
    def testSubscriptionStatusModel(self):
        """Test SubscriptionStatusModel"""
        # inst = SubscriptionStatusModel()
