...
class TestHealthInformationNotificationNotificationModel(unittest.TestCase):
    """HealthInformationNotificationNotificationModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HealthInformationNotificationNotificationModel:
        """Test HealthInformationNotificationNotificationModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HealthInformationNotificationNotificationModel`
        """
        model = HealthInformationNotificationNotificationModel()
        if include_optional:
            return HealthInformationNotificationNotificationModel(
                consent_id = '',
                transaction_id = '',
    ...
    def testHealthInformationNotificationNotificationModel(self):
        """Test HealthInformationNotificationNotificationModel"""
