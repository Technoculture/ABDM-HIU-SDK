...
class TestConsentFetchRequestModel(unittest.TestCase):
    """ConsentFetchRequestModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConsentFetchRequestModel:
        """Test ConsentFetchRequestModel
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ConsentFetchRequestModel`
        """
        model = ConsentFetchRequestModel()
        if include_optional:
            return ConsentFetchRequestModel(
    ...
    def testConsentFetchRequestModel(self):
        """Test ConsentFetchRequestModel"""
