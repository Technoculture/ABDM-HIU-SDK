...
class TestConsentAcknowledgementModel(unittest.TestCase):
    """ConsentAcknowledgementModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConsentAcknowledgementModel:
        """Test ConsentAcknowledgementModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConsentAcknowledgementModel`
        """
        model = ConsentAcknowledgementModel()
        if include_optional:
            return ConsentAcknowledgementModel(
                status = 'OK',
    ...
    def testConsentAcknowledgementModel(self):
        """Test ConsentAcknowledgementModel"""
