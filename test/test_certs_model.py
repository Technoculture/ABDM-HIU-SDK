...
class TestCertsModel(unittest.TestCase):
    """CertsModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CertsModel:
        """Test CertsModel
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CertsModel`
        """
        model = CertsModel()
        if include_optional:
            return CertsModel(
                keys = [
                    abdm.models.certificate_or_key_get_schema.CertificateOrKeyGetSchema(
                        e = '', 
                        kid = '', 
                        kty = '', 
                        n = '', 
