...
class TestSubscriptionPeriodModel(unittest.TestCase):
    """SubscriptionPeriodModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionPeriodModel:
        """Test SubscriptionPeriodModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionPeriodModel`
        """
        model = SubscriptionPeriodModel()
        if include_optional:
    ...
    def testSubscriptionPeriodModel(self):
        """Test SubscriptionPeriodModel"""
