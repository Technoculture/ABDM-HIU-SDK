...
class TestPatientAuthInitRequestQueryRequester(unittest.TestCase):
    """PatientAuthInitRequestQueryRequester unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatientAuthInitRequestQueryRequester:
        """Test PatientAuthInitRequestQueryRequester
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PatientAuthInitRequestQueryRequester`
        """
        model = PatientAuthInitRequestQueryRequester()
        if include_optional:
    ...
    def testPatientAuthInitRequestQueryRequester(self):
        """Test PatientAuthInitRequestQueryRequester"""
