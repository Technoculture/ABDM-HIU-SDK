...
class TestRequesterModel(unittest.TestCase):
    """RequesterModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequesterModel:
        """Test RequesterModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequesterModel`
        """
