...
class TestSessionRequestModel(unittest.TestCase):
    """SessionRequestModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SessionRequestModel:
        """Test SessionRequestModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SessionRequestModel`
        """
        model = SessionRequestModel()
        if include_optional:
    ...
    def testSessionRequestModel(self):
        """Test SessionRequestModel"""
