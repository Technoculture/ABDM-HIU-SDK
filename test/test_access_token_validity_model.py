...
class TestAccessTokenValidityModel(unittest.TestCase):
    """AccessTokenValidityModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessTokenValidityModel:
        """Test AccessTokenValidityModel
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AccessTokenValidityModel`
        """
        model = AccessTokenValidityModel()
        if include_optional:
            return AccessTokenValidityModel(
                purpose = 'LINK',
    ...
    def testAccessTokenValidityModel(self):
        """Test AccessTokenValidityModel"""
