...
class TestConsentModel(unittest.TestCase):
    """ConsentModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConsentModel:
        """Test ConsentModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConsentModel`
        """
        model = ConsentModel()
        if include_optional:
            return ConsentModel(
