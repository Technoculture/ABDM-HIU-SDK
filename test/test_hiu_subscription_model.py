...
class TestHIUSubscriptionModel(unittest.TestCase):
    """HIUSubscriptionModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HIUSubscriptionModel:
        """Test HIUSubscriptionModel
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HIUSubscriptionModel`
        """
        model = HIUSubscriptionModel()
        if include_optional:
            return HIUSubscriptionModel(
                id = 'subscription Id',
    ...
    def testHIUSubscriptionModel(self):
        """Test HIUSubscriptionModel"""
