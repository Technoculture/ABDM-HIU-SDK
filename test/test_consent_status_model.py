...
class TestConsentStatusModel(unittest.TestCase):
    """ConsentStatusModel unit test stubs"""
    ...
    def testConsentStatusModel(self):
        """Test ConsentStatusModel"""
        # inst = ConsentStatusModel()
