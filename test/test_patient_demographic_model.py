...
class TestPatientDemographicModel(unittest.TestCase):
    """PatientDemographicModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatientDemographicModel:
        """Test PatientDemographicModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatientDemographicModel`
        """
        model = PatientDemographicModel()
        if include_optional:
            return PatientDemographicModel(
                name = 'janki das',
                gender = 'M',
    ...
    def testPatientDemographicModel(self):
        """Test PatientDemographicModel"""
