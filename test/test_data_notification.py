...
class TestDataNotification(unittest.TestCase):
    """DataNotification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataNotification:
        """Test DataNotification
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DataNotification`
        """
        model = DataNotification()
        if include_optional:
