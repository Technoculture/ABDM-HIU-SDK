...
class TestEntryLinkModel(unittest.TestCase):
    """EntryLinkModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntryLinkModel:
        """Test EntryLinkModel
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `EntryLinkModel`
        """
        model = EntryLinkModel()
        if include_optional:
