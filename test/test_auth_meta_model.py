...
class TestAuthMetaModel(unittest.TestCase):
    """AuthMetaModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthMetaModel:
        """Test AuthMetaModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthMetaModel`
        """
        model = AuthMetaModel()
        if include_optional:
            return AuthMetaModel(
                hint = '',
