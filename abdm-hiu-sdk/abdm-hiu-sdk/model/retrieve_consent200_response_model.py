...
class RetrieveConsent200ResponseModel(BaseModel):
    """
    RetrieveConsent200ResponseModel
    """ # noqa: E501
    consent: Optional[RetrieveConsent200ResponseConsentModelModel] = None
    __properties: ClassVar[List[str]] = ["consent"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "consent": RetrieveConsent200ResponseConsentModelModel.from_dict(obj["consent"]) if obj.get("consent") is not None else None
        })
        return _obj
