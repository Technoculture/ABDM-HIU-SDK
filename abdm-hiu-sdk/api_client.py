...
from abdm-hiu-sdk.api_response import ApiResponse, T as ApiResponseT
import abdm-hiu-sdk.abdm-hiu-sdk.model
from abdm-hiu-sdk import rest
from abdm-hiu-sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(abdm-hiu-sdk.abdm-hiu-sdk.model, klass)
