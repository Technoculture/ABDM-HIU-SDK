...
from abdm.api_response import ApiResponse, T as ApiResponseT
import abdm.abdm.model
from abdm import rest
from abdm.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(abdm.abdm.model, klass)
