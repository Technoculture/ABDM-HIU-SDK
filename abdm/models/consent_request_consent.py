...
class ConsentRequestConsent(BaseModel):
    ...
    care_contexts: Optional[List[CareContextDefinition]] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "patient": ConsentRequestConsentPatient.from_dict(obj["patient"])
                ...
                "careContexts": [
                    CareContextDefinition.from_dict(_item)
