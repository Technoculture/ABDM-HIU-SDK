...
class HIUHealthInformationRequestResponse(BaseModel):
    ...
    hi_request: Optional[HIUHealthInformationRequestResponseHiRequest] = Field(
        default=None, alias="hiRequest"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "hiRequest": HIUHealthInformationRequestResponseHiRequest.from_dict(
                    obj["hiRequest"]
                )
