...
class HiuPatientStatusNotificationNotification(BaseModel):
    """
    HiuPatientStatusNotificationNotification
    """  # noqa: E501

    status: StrictStr
    patient: HiuPatientStatusNotificationNotificationPatient
        ...
        _obj = cls.model_validate(
            {
                ...
                "patient": HiuPatientStatusNotificationNotificationPatient.from_dict(
                    obj["patient"]
                )
