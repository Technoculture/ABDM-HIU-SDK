...
class HealthInformationNotificationNotification(BaseModel):
    ...
    status_notification: HealthInformationNotificationNotificationStatusNotification = (
        Field(alias="statusNotification")
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "notifier": HealthInformationNotificationNotificationNotifier.from_dict(
                    obj["notifier"]
                )
                if obj.get("notifier") is not None
                else None,
                "statusNotification": HealthInformationNotificationNotificationStatusNotification.from_dict(
