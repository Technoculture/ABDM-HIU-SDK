...
class PatientAuthNotificationAcknowledgement(BaseModel):
    ...
    acknowledgement: Optional[PatientAuthNotificationAcknowledgementAcknowledgement] = (
        None
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "acknowledgement": PatientAuthNotificationAcknowledgementAcknowledgement.from_dict(
                    obj["acknowledgement"]
                )
