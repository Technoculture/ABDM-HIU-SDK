...
class HIUSubscriptionRequestReceipt(BaseModel):
    ...
    subscription_request: Optional[ConsentRequestInitResponseConsentRequest] = Field(
        default=None, alias="subscriptionRequest"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "subscriptionRequest": ConsentRequestInitResponseConsentRequest.from_dict(
