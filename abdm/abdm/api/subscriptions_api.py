...
from abdm.models.hiu_subscription_notification_model import (
    HIUSubscriptionNotificationModel,
)
from abdm.models.hiu_subscription_request_receipt_model import (
    HIUSubscriptionRequestReceiptModel,
)
from abdm.models.subscription_approval_notification_model import (
...
class SubscriptionsAPI:
    ...
    def v05_subscription_requests_hiu_notify_post(
        ...
        subscription_approval_notification_model: SubscriptionApprovalNotificationModel,
        ...
        :type x_hiu_id: str
        :param subscription_approval_notification_model: (required)
        :type subscription_approval_notification_model: SubscriptionApprovalNotificationModel
        ...
        _param = self._v05_subscription_requests_hiu_notify_post_serialize(
            ...
            x_hiu_id=x_hiu_id,
            subscription_approval_notification_model=subscription_approval_notification_model,
    ...
    def _v05_subscription_requests_hiu_notify_post_serialize(
        ...
        authorization,
        x_hiu_id,
        subscription_approval_notification_model,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if subscription_approval_notification_model is not None:
            _body_params = subscription_approval_notification_model
    ...
    @validate_call
    def v05_subscription_requests_hiu_on_init_post(
        self,
        authorization: Annotated[
            StrictStr,
            Field(
        ...
        hiu_subscription_request_receipt_model: HIUSubscriptionRequestReceiptModel,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param x_hiu_id: Identifier of the health information user to which the request was intended. (required)
        :type x_hiu_id: str
        :param hiu_subscription_request_receipt_model: (required)
        :type hiu_subscription_request_receipt_model: HIUSubscriptionRequestReceiptModel
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._v05_subscription_requests_hiu_on_init_post_serialize(
            authorization=authorization,
            x_hiu_id=x_hiu_id,
            hiu_subscription_request_receipt_model=hiu_subscription_request_receipt_model,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def v05_subscription_requests_hiu_on_init_post_with_http_info(
        self,
        authorization: Annotated[
            StrictStr,
            Field(
    ...
    @validate_call
    def v05_subscription_requests_hiu_on_init_post_without_preload_content(
        self,
        authorization: Annotated[
            StrictStr,
            Field(
    ...
    def _v05_subscription_requests_hiu_on_init_post_serialize(
        self,
        authorization,
        x_hiu_id,
        hiu_subscription_request_receipt_model,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if hiu_subscription_request_receipt_model is not None:
            _body_params = hiu_subscription_request_receipt_model
    ...
    def v05_subscriptions_hiu_notify_post(
        ...
        hiu_subscription_notification_model: HIUSubscriptionNotificationModel,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param x_hiu_id: Identifier of the health information user to which the request was intended. (required)
        :type x_hiu_id: str
        :param hiu_subscription_notification_model: (required)
        :type hiu_subscription_notification_model: HIUSubscriptionNotificationModel
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._v05_subscriptions_hiu_notify_post_serialize(
            authorization=authorization,
            x_hiu_id=x_hiu_id,
            hiu_subscription_notification_model=hiu_subscription_notification_model,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    def _v05_subscriptions_hiu_notify_post_serialize(
        ...
        authorization,
        x_hiu_id,
        hiu_subscription_notification_model,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if hiu_subscription_notification_model is not None:
            _body_params = hiu_subscription_notification_model
