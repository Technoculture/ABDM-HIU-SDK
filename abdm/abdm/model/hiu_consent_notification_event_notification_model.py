        ...
        _obj = cls.model_validate(
            {
                ...
                "consentArtefacts": [
                    ConsentArtefactReferenceModelModel.from_dict(_item)
                    for _item in obj["consentArtefacts"]
                ]
                if obj.get("consentArtefacts") is not None
                else None,
            }
        )
        return _obj
