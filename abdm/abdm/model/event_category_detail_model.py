...
class EventCategoryDetailModel(BaseModel):
    """
    EventCategoryDetailModel
    """ # noqa: E501
    care_context: CareContextDefinitionModelModel = Field(alias="careContext")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "careContext": CareContextDefinitionModelModel.from_dict(obj["careContext"]) if obj.get("careContext") is not None else None,
