...
class SubscriptionRequestSubscriptionModel(BaseModel):
    """
    SubscriptionRequestSubscriptionModel
    """ # noqa: E501
    purpose: UsePurposeModelModel
    patient: ConsentManagerPatientIDModelModel
    hiu: OrganizationRepresentationModelModel
    hips: Optional[List[OrganizationRepresentationModelModel]] = None
    categories: List[SubscriptionCategoryModelModel]
    period: SubscriptionPeriodModelModel
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hiu": OrganizationRepresentationModelModel.from_dict(obj["hiu"]) if obj.get("hiu") is not None else None,
            "hips": [OrganizationRepresentationModelModel.from_dict(_item) for _item in obj["hips"]] if obj.get("hips") is not None else None,
            "categories": obj.get("categories"),
            "period": SubscriptionPeriodModelModel.from_dict(obj["period"]) if obj.get("period") is not None else None
        })
        return _obj
