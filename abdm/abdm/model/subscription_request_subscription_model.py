        ...
        _obj = cls.model_validate(
            {
                ...
                "hiu": OrganizationRepresentationModelModel.from_dict(obj["hiu"])
                if obj.get("hiu") is not None
                else None,
                "hips": [
                    OrganizationRepresentationModelModel.from_dict(_item)
                    for _item in obj["hips"]
                ]
                if obj.get("hips") is not None
                else None,
                "categories": obj.get("categories"),
                "period": SubscriptionPeriodModelModel.from_dict(obj["period"])
