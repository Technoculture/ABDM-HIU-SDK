...
class HIUSubscriptionModel(BaseModel):
    """
    ...
    sources: List[HIUSubscriptionContextModelModel]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sources": [HIUSubscriptionContextModelModel.from_dict(_item) for _item in obj["sources"]] if obj.get("sources") is not None else None
        })
        return _obj
