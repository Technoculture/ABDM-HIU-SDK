...
class HIUSubscriptionNotificationModel(BaseModel):
    """
    ...
    event: HIUSubscriptionNotificationEventModelModel
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "event": HIUSubscriptionNotificationEventModelModel.from_dict(obj["event"]) if obj.get("event") is not None else None
        })
        return _obj
