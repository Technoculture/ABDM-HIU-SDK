...
class PatientIdentificationResponseModel(BaseModel):
    """
    ...
    patient: Optional[PatientIdentificationResponsePatientModelModel] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "patient": PatientIdentificationResponsePatientModelModel.from_dict(obj["patient"]) if obj.get("patient") is not None else None,
