...
class PatientDemographicResponseModel(BaseModel):
    """
    PatientDemographicResponseModel
    """ # noqa: E501
    id: StrictStr = Field(description="PHR Identifier of patient at consent manager")
    name: StrictStr
    gender: PatientGenderModelModel
    year_of_birth: StrictInt = Field(alias="yearOfBirth")
    address: Optional[PatientAddressModelModel] = None
    identifiers: Optional[List[IdentifierModelModel]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "address": PatientAddressModelModel.from_dict(obj["address"]) if obj.get("address") is not None else None,
            "identifiers": [IdentifierModelModel.from_dict(_item) for _item in obj["identifiers"]] if obj.get("identifiers") is not None else None
        })
        return _obj
