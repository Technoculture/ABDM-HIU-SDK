...
class PatientDemographicModel(BaseModel):
    """
    ...
    date_of_birth: StrictStr = Field(
        description="date of birth in YYYY-MM-DD format.", alias="dateOfBirth"
    )
    identifier: Optional[AuthConfirmIdentifierModelModel] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "identifier": AuthConfirmIdentifierModelModel.from_dict(
                    obj["identifier"]
                )
