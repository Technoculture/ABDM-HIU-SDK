...
class HIUHealthInformationRequestResponseModel(BaseModel):
    """
    ...
    hi_request: Optional[HIUHealthInformationRequestResponseHiRequestModelModel] = Field(default=None, alias="hiRequest")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hiRequest": HIUHealthInformationRequestResponseHiRequestModelModel.from_dict(obj["hiRequest"]) if obj.get("hiRequest") is not None else None,
