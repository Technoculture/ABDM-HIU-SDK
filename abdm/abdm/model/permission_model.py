...
class PermissionModel(BaseModel):
    ...
    date_range: PermissionDateRangeModelModel = Field(alias="dateRange")
    data_erase_at: datetime = Field(alias="dataEraseAt")
    frequency: PermissionFrequencyModelModel
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dateRange": PermissionDateRangeModelModel.from_dict(obj["dateRange"]) if obj.get("dateRange") is not None else None,
            "dataEraseAt": obj.get("dataEraseAt"),
            "frequency": PermissionFrequencyModelModel.from_dict(obj["frequency"]) if obj.get("frequency") is not None else None
        })
        return _obj
