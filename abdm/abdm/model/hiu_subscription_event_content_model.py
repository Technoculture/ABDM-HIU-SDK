...
class HIUSubscriptionEventContentModel(BaseModel):
    """
    HIUSubscriptionEventContentModel
    """ # noqa: E501
    patient: ConsentManagerPatientIDModelModel
    hip: OrganizationRepresentationModelModel
    context: List[EventCategoryDetailModelModel]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hip": OrganizationRepresentationModelModel.from_dict(obj["hip"]) if obj.get("hip") is not None else None,
            "context": [EventCategoryDetailModelModel.from_dict(_item) for _item in obj["context"]] if obj.get("context") is not None else None
        })
        return _obj
