...
class HIUConsentNotificationResponseModel(BaseModel):
    """
    ...
    acknowledgement: Optional[List[ConsentAcknowledgementModelModel]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "acknowledgement": [ConsentAcknowledgementModelModel.from_dict(_item) for _item in obj["acknowledgement"]] if obj.get("acknowledgement") is not None else None,
