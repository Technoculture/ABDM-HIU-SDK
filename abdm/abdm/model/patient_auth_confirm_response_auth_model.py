...
class PatientAuthConfirmResponseAuthModel(BaseModel):
    """
    ...
    validity: Optional[AccessTokenValidityModelModel] = None
    patient: Optional[PatientDemographicResponseModelModel] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "validity": AccessTokenValidityModelModel.from_dict(obj["validity"]) if obj.get("validity") is not None else None,
            "patient": PatientDemographicResponseModelModel.from_dict(obj["patient"]) if obj.get("patient") is not None else None
        })
        return _obj
