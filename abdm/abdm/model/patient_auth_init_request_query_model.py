...
class PatientAuthInitRequestQueryModel(BaseModel):
    """
    PatientAuthInitRequestQueryModel
    """ # noqa: E501
    id: StrictStr = Field(description="id  of the patient understood by the CM")
    purpose: PatientAuthPurposeModelModel
    auth_mode: Optional[AuthenticationModeModelModel] = Field(default=None, alias="authMode")
    requester: PatientAuthInitRequestQueryRequesterModelModel
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "requester": PatientAuthInitRequestQueryRequesterModelModel.from_dict(obj["requester"]) if obj.get("requester") is not None else None
        })
        return _obj
