...
class PatientAuthConfirmRequestCredentialModel(BaseModel):
    """
    ...
    demographic: Optional[PatientDemographicModelModel] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "demographic": PatientDemographicModelModel.from_dict(obj["demographic"]) if obj.get("demographic") is not None else None
        })
        return _obj
