...
class AccessTokenValidityModel(BaseModel):
    """
    AccessTokenValidityModel
    """ # noqa: E501
    purpose: PatientAuthPurposeModelModel
    requester: PatientAuthRequesterModelModel
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "requester": PatientAuthRequesterModelModel.from_dict(obj["requester"]) if obj.get("requester") is not None else None,
