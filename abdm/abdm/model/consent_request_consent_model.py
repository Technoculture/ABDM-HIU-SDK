...
class ConsentRequestConsentModel(BaseModel):
    """
    ConsentRequestConsentModel
    """ # noqa: E501
    purpose: UsePurposeModelModel
    patient: ConsentRequestConsentPatientModelModel
    hip: Optional[ConsentArtefactResponseConsentConsentDetailHipModelModel] = None
    care_contexts: Optional[List[CareContextDefinitionModelModel]] = Field(default=None, alias="careContexts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "patient": ConsentRequestConsentPatientModelModel.from_dict(obj["patient"]) if obj.get("patient") is not None else None,
            "hip": ConsentArtefactResponseConsentConsentDetailHipModelModel.from_dict(obj["hip"]) if obj.get("hip") is not None else None,
            "careContexts": [CareContextDefinitionModelModel.from_dict(_item) for _item in obj["careContexts"]] if obj.get("careContexts") is not None else None,
