...
class ConsentRequestConsentModel(BaseModel):
    ...
    care_contexts: Optional[List[CareContextDefinitionModelModel]] = Field(
        default=None, alias="careContexts"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "patient": ConsentRequestConsentPatientModelModel.from_dict(
                    obj["patient"]
                )
                ...
                "careContexts": [
                    CareContextDefinitionModelModel.from_dict(_item)
