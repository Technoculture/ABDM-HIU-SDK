...
class ConsentArtefactResponseConsentConsentDetailModel(BaseModel):
    ...
    care_contexts: List[
        ConsentArtefactResponseConsentConsentDetailCareContextsInnerModelModel
    ] = Field(alias="careContexts")
    ...
    consent_manager: ConsentArtefactResponseConsentConsentDetailConsentManagerModelModel = Field(
        alias="consentManager"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "patient": ConsentManagerPatientIDModelModel.from_dict(obj["patient"])
                if obj.get("patient") is not None
                else None,
                "careContexts": [
                    ConsentArtefactResponseConsentConsentDetailCareContextsInnerModelModel.from_dict(
                        _item
                    )
                    for _item in obj["careContexts"]
                ]
                if obj.get("careContexts") is not None
                else None,
                "purpose": UsePurposeModelModel.from_dict(obj["purpose"])
                if obj.get("purpose") is not None
                else None,
                "hip": ConsentArtefactResponseConsentConsentDetailHipModelModel.from_dict(
                    obj["hip"]
                )
                if obj.get("hip") is not None
                else None,
                "hiu": ConsentArtefactResponseConsentConsentDetailHiuModelModel.from_dict(
                    obj["hiu"]
                )
                if obj.get("hiu") is not None
                else None,
                "consentManager": ConsentArtefactResponseConsentConsentDetailConsentManagerModelModel.from_dict(
                    obj["consentManager"]
                )
                if obj.get("consentManager") is not None
                else None,
                "requester": RequesterModelModel.from_dict(obj["requester"])
                if obj.get("requester") is not None
                else None,
                "hiTypes": obj.get("hiTypes"),
                "permission": PermissionModelModel.from_dict(obj["permission"])
