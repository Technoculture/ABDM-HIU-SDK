...
class HIUSubscriptionRequestReceiptModel(BaseModel):
    ...
    subscription_request: Optional[
        ConsentRequestInitResponseConsentRequestModelModel
    ] = Field(default=None, alias="subscriptionRequest")
        ...
        _obj = cls.model_validate(
            {
                ...
                "subscriptionRequest": ConsentRequestInitResponseConsentRequestModelModel.from_dict(
                    obj["subscriptionRequest"]
                )
                if obj.get("subscriptionRequest") is not None
                else None,
