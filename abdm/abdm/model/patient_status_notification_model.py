...
class PatientStatusNotificationModel(BaseModel):
    """
    ...
    acknowledgment: PatientAuthNotificationAcknowledgementAcknowledgementModelModel
    error: Optional[ErrorModelModel] = None
    resp: Optional[RequestReferenceModelModel] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "acknowledgment": PatientAuthNotificationAcknowledgementAcknowledgementModelModel.from_dict(obj["acknowledgment"]) if obj.get("acknowledgment") is not None else None,
