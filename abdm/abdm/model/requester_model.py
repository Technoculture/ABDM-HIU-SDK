...
class RequesterModel(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr
    identifier: Optional[RequesterIdentifierModelModel] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "identifier": RequesterIdentifierModelModel.from_dict(obj["identifier"]) if obj.get("identifier") is not None else None
        })
        return _obj
