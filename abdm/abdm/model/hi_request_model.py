...
class HIRequestModel(BaseModel):
    """
    HIRequestModel
    """ # noqa: E501
    ...
    hi_request: HIRequestHiRequestModelModel = Field(alias="hiRequest")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hiRequest": HIRequestHiRequestModelModel.from_dict(obj["hiRequest"]) if obj.get("hiRequest") is not None else None
        })
        return _obj
