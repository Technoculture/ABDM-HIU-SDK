...
class PatientAuthModeQueryRequestQueryModel(BaseModel):
    """
    PatientAuthModeQueryRequestQueryModel
    """ # noqa: E501
    id: StrictStr
    purpose: PatientAuthPurposeModelModel
    requester: PatientAuthModeQueryRequestQueryRequesterModelModel
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "requester": PatientAuthModeQueryRequestQueryRequesterModelModel.from_dict(obj["requester"]) if obj.get("requester") is not None else None
        })
        return _obj
