...
class PatientAuthInitResponseAuthModel(BaseModel):
    """
    PatientAuthInitResponseAuthModel
    """ # noqa: E501
    transaction_id: StrictStr = Field(alias="transactionId")
    mode: AuthenticationModeModelModel
    meta: Optional[AuthMetaModelModel] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mode": obj.get("mode"),
            "meta": AuthMetaModelModel.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
