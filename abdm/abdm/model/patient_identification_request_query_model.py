...
class PatientIdentificationRequestQueryModel(BaseModel):
    """
    PatientIdentificationRequestQueryModel
    """ # noqa: E501
    patient: PatientIdentificationRequestQueryPatientModelModel
    requester: PatientIdentificationRequestQueryRequesterModelModel
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "patient": PatientIdentificationRequestQueryPatientModelModel.from_dict(obj["patient"]) if obj.get("patient") is not None else None,
            "requester": PatientIdentificationRequestQueryRequesterModelModel.from_dict(obj["requester"]) if obj.get("requester") is not None else None
        })
        return _obj
