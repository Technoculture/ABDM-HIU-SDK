...
class HIRequestHiRequestModel(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "consent": ConsentModelModel.from_dict(obj["consent"]) if obj.get("consent") is not None else None,
            "dateRange": DateRangeModelModel.from_dict(obj["dateRange"]) if obj.get("dateRange") is not None else None,
