...
class HIRequestHiRequestModel(BaseModel):
    """
    HIRequestHiRequestModel
    """  # noqa: E501

    consent: ConsentModelModel
    date_range: DateRangeModelModel = Field(alias="dateRange")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "consent": ConsentModelModel.from_dict(obj["consent"])
                if obj.get("consent") is not None
                else None,
                "dateRange": DateRangeModelModel.from_dict(obj["dateRange"])
