...
class PatientAuthNotificationAuthModel(BaseModel):
    ...
    transaction_id: StrictStr = Field(
        description="transaction id for auth session", alias="transactionId"
    )
    status: StrictStr
        ...
        _obj = cls.model_validate(
            {
                ...
                "validity": AccessTokenValidityModelModel.from_dict(obj["validity"])
                if obj.get("validity") is not None
                else None,
                "patient": PatientDemographicResponseModelModel.from_dict(
                    obj["patient"]
                )
