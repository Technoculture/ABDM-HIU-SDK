...
class ConsentArtefactResponseConsentModel(BaseModel):
    ...
    consent_detail: ConsentArtefactResponseConsentConsentDetailModelModel = Field(
        alias="consentDetail"
    )
    signature: StrictStr
        ...
        _obj = cls.model_validate(
            {
                ...
                "consentDetail": ConsentArtefactResponseConsentConsentDetailModelModel.from_dict(
                    obj["consentDetail"]
                )
                if obj.get("consentDetail") is not None
                else None,
