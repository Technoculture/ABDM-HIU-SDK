...
class HIUSubscriptionRequestNotificationAcknowledgementModel(BaseModel):
    ...
    acknowledgement: Optional[
        HIUSubscriptionRequestNotificationAcknowledgementAcknowledgementModelModel
    ] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "acknowledgement": HIUSubscriptionRequestNotificationAcknowledgementAcknowledgementModelModel.from_dict(
                    obj["acknowledgement"]
                )
                if obj.get("acknowledgement") is not None
                else None,
                "error": ErrorModelModel.from_dict(obj["error"])
                if obj.get("error") is not None
                else None,
                "resp": RequestReferenceModelModel.from_dict(obj["resp"])
