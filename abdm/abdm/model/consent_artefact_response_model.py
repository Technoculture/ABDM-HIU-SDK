...
class ConsentArtefactResponseModel(BaseModel):
    """
    ...
    consent: Optional[ConsentArtefactResponseConsentModelModel] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "consent": ConsentArtefactResponseConsentModelModel.from_dict(obj["consent"]) if obj.get("consent") is not None else None,
