...
class HIUConsentRequestStatusModel(BaseModel):
    ...
    consent_request: Optional[HIUConsentRequestStatusConsentRequestModelModel] = Field(
        default=None, alias="consentRequest"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "consentRequest": HIUConsentRequestStatusConsentRequestModelModel.from_dict(
                    obj["consentRequest"]
                )
