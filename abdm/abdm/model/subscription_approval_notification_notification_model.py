...
class SubscriptionApprovalNotificationNotificationModel(BaseModel):
    """
    SubscriptionApprovalNotificationNotificationModel
    """  # noqa: E501

    subscription_request_id: Optional[StrictStr] = Field(
        default=None, alias="subscriptionRequestId"
    )
    status: SubscriptionStatusModelModel
    subscription: Optional[HIUSubscriptionModelModel] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "subscription": HIUSubscriptionModelModel.from_dict(obj["subscription"])
