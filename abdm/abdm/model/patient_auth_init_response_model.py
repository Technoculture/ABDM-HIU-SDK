...
class PatientAuthInitResponseModel(BaseModel):
    """
    ...
    auth: Optional[PatientAuthInitResponseAuthModelModel] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "auth": PatientAuthInitResponseAuthModelModel.from_dict(obj["auth"]) if obj.get("auth") is not None else None,
