...
class HiuPatientStatusNotificationNotificationModel(BaseModel):
    """
    HiuPatientStatusNotificationNotificationModel
    """  # noqa: E501

    status: StrictStr
    patient: HiuPatientStatusNotificationNotificationPatientModelModel
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(["DEACTIVATED", "REACTIVATED", "DELETED"]):
            raise ValueError(
                "must be one of enum values ('DEACTIVATED', 'REACTIVATED', 'DELETED')"
            )
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "patient": HiuPatientStatusNotificationNotificationPatientModelModel.from_dict(
                    obj["patient"]
                )
