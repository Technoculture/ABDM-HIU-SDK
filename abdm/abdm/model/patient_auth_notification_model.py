...
class PatientAuthNotificationModel(BaseModel):
    """
    ...
    auth: Optional[PatientAuthNotificationAuthModelModel] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "auth": PatientAuthNotificationAuthModelModel.from_dict(obj["auth"]) if obj.get("auth") is not None else None
        })
        return _obj
