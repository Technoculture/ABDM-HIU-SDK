...
class KeyMaterialModel(BaseModel):
    """
    KeyMaterialModel
    """ # noqa: E501
    crypto_alg: StrictStr = Field(alias="cryptoAlg")
    curve: StrictStr
    dh_public_key: KeyObjectModelModel = Field(alias="dhPublicKey")
    nonce: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "curve": obj.get("curve"),
            "dhPublicKey": KeyObjectModelModel.from_dict(obj["dhPublicKey"]) if obj.get("dhPublicKey") is not None else None,
            "nonce": obj.get("nonce")
        })
        return _obj
